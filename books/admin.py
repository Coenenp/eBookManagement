...
class FinalMetadataInline(admin.StackedInline):
    ...
    fieldsets = (
        ("Final Choices", {"fields": ("final_title", "final_title_confidence", "final_author", "final_author_confidence")}),
        ("Quality", {"fields": ("overall_confidence", "completeness_score", "last_updated"), "classes": ("collapse",)}),
    )
...
class ScanFolderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "path", "content_type", "language")}),
        ("Status", {"fields": ("is_active",)}),
        ("Timestamps", {"fields": ("created_at", "last_scanned"), "classes": ("collapse",)}),
    )
...
class BookAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Book Information", {"fields": ("content_type",)}),
        ("File Information", {"fields": ("file_format", "file_size_mb", "file_path_display"), "classes": ("collapse",)}),
        (
            "Status",
            {
        ...
        ("Scan Information", {"fields": ("scan_folder", "first_scanned", "last_scanned"), "classes": ("collapse",)}),
    )
...
class BookAuthorAdmin(admin.ModelAdmin):
    list_display = ("author_full_name", "author_first_name", "author_last_name", "book", "source", "confidence", "is_main_author", "created_at")
...
class BookCoverAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("book", "cover_path", "source", "confidence")}),
        ("Image Properties", {"fields": ("width", "height", "aspect_ratio", "file_size", "format", "is_high_resolution")}),
        ("System", {"fields": ("resolution_str", "is_local_file", "created_at"), "classes": ("collapse",)}),
    )
...
class FinalMetadataAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Series Information", {"fields": ("final_series", "final_series_number", "final_series_confidence")}),
        ("Cover Information", {"fields": ("final_cover_path", "final_cover_confidence", "has_cover")}),
        ("Publication Information", {"fields": ("language", "isbn", "publication_year", "description")}),
        ("Quality Metrics", {"fields": ("overall_confidence", "completeness_score", "is_reviewed"), "classes": ("collapse",)}),
        ("System", {"fields": ("last_updated",), "classes": ("collapse",)}),
    )
...
class BookFileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("File Information", {"fields": ("book", "file_path", "file_format", "file_size", "file_size_display")}),
        ("Associated Files", {"fields": ("opf_path", "cover_path"), "classes": ("collapse",)}),
        ("System Information", {"fields": ("file_path_hash", "first_scanned", "last_scanned"), "classes": ("collapse",)}),
    )
