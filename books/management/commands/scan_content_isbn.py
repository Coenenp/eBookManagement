...
from books.scanner.extractors.content_isbn import bulk_scan_content_isbns, save_content_isbns
import logging
        ...
        if options['book_id']:
            try:
                ...
                if content_isbns > 0:
                    ...
                    self.stdout.write(
                        self.style.WARNING("No ISBNs found in content")
                    )
