...
urlpatterns = [
    ...
    path("book/<int:book_id>/fix-author/", author_management_views.fix_books_by_author, name="book_fix_author"),
    # Author management
    ...
    path("authors/clean/", author_management_views.clean_authors_ajax, name="author_clean"),
    path("authors/normalize/", author_management_views.normalize_authors_ajax, name="author_normalize"),
    ...
    path("ajax/clean-cover-cache/", ajax_cover_views.clean_cover_cache_ajax, name="ajax_clean_cover_cache"),
    ...
    path("delete_file/<int:file_id>/", views.ajax_delete_book_file, name="delete_file"),
    path("clear_cache/", views.clear_cache_view, name="clear_cache"),
    path("debug_view/", views.debug_view, name="debug_view"),
    path("system_status/", views.system_status_view, name="system_status"),
