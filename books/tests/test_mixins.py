...
class StandardWidgetMixinTests(TestCase):
    ...
    def test_number_with_range(self):
        ...
        widget = self.mixin.number_with_range(min_val=1, max_val=100, step=1, placeholder="Enter number")
...
class MetadataFormMixinTests(TestCase):
    ...
    def test_clean_publication_year_valid(self):
        ...
        form = self.form_class(data={"final_title": "Valid Title", "final_author": "Valid Author", "publication_year": 2023})
        self.assertTrue(form.is_valid())
    ...
    def test_clean_publication_year_invalid(self):
        ...
        form = self.form_class(data={"final_title": "Valid Title", "final_author": "Valid Author", "publication_year": 999})  # Too early
        self.assertFalse(form.is_valid())
        self.assertIn("publication_year", form.errors)

    def test_clean_isbn_valid(self):
        """Test cleaning valid ISBN"""
        form = self.form_class(data={"final_title": "Valid Title", "final_author": "Valid Author", "isbn": "9780123456789"})
        self.assertTrue(form.is_valid())
        self.assertEqual(form.cleaned_data["isbn"], "9780123456789")

    def test_clean_isbn_invalid(self):
        """Test cleaning invalid ISBN"""
        form = self.form_class(data={"final_title": "Valid Title", "final_author": "Valid Author", "isbn": "123"})  # Too short
        self.assertFalse(form.is_valid())
        self.assertIn("isbn", form.errors)

    def test_clean_manual_genres_valid(self):
        """Test cleaning valid manual genres"""
        form = self.form_class(data={"final_title": "Valid Title", "final_author": "Valid Author", "manual_genres": "Science Fiction, Fantasy, Adventure"})
        self.assertTrue(form.is_valid())
...
class MixinIntegrationTests(TestCase):
    ...
    def test_multiple_mixin_inheritance(self):
        ...
        form = CompleteForm(data={"final_title": "Test Book", "final_author": "Test Author", "publication_year": 2023, "isbn": "9780123456789"})
    ...
    def test_widget_and_validator_integration(self):
        ...
        field_with_validators = forms.IntegerField(widget=widget, validators=[MinValueValidator(1000), MaxValueValidator(2030)])
    ...
    def test_mixin_error_handling(self):
        ...
        form = TestForm(data={"final_title": "", "final_author": "Valid Author", "publication_year": 999})  # Required field empty  # Invalid year
