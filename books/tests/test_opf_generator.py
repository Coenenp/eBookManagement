...
class OPFGenerationTests(TestCase):
    ...
    def test_generate_opf_with_ebook_filename(self):
        ...
        opf_content = generate_opf_from_final_metadata(self.final_metadata, ebook_filename="test_book.epub")
    ...
    def test_opf_generation_with_minimal_metadata(self):
        ...
        minimal_metadata = FinalMetadata.objects.create(
            book=create_test_book_with_file(file_path="/test/minimal.epub", file_format="epub", file_size=1000, scan_folder=self.scan_folder),
