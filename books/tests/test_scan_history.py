...
def test_simple_scan_history():
    ...
    scan_folder = ScanFolder.objects.create(name="Test Folder", path="/test/path", language="en", content_type="ebooks")
...
def test_scan_history_model():
    ...
    scan_folder = ScanFolder.objects.create(name="Test Folder", path="/test/path", language="en", content_type="comics")
...
class TestScanHistory(TestCase):
    ...
    def test_create_multiple_scan_entries(self):
        ...
        # Create a test scan folder
        scan_folder = ScanFolder.objects.create(name="Comics Folder", path="/path/to/comics", content_type="comics")
