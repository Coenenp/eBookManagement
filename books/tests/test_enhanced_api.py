...
def test_enhanced_api_endpoints():
    ...
    print("\n2⃣  Testing Comics List API with Sub-rows...")
    ...
    print("\n3⃣  Testing Series List API with Sub-rows...")
    ...
    print("\n4⃣  Testing Audiobooks List API...")
    ...
    print("\n5⃣  Testing Detail Endpoints with File Aggregation...")
