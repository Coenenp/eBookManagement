# Generated by Django 5.2.6 on 2025-09-14 01:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Filename', 'Filename'), ('EPUB', 'EPUB'), ('MOBI', 'MOBI'), ('PDF', 'PDF'), ('OPF File', 'OPF File'), ('Open Library', 'Open Library'), ('Google Books', 'Google Books'), ('Open Library Covers', 'Open Library Covers'), ('Google Books Covers', 'Google Books Covers'), ('Original Scan', 'Original Scan'), ('Manual Entry', 'Manual Entry'), ('content_scan', 'Content Scan')], max_length=50, unique=True)),
