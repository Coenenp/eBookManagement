# Generated by Django 5.2.6 on 2025-10-07 12:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_hash', models.CharField(db_index=True, editable=False, max_length=64)),
                ('narrator', models.CharField(blank=True, max_length=500)),
                ('publisher', models.CharField(blank=True, max_length=200)),
                ('description', models.TextField(blank=True)),
                ('total_duration_seconds', models.IntegerField(blank=True, help_text='Total duration across all files', null=True)),
                ('total_size_bytes', models.BigIntegerField(blank=True, help_text='Total size across all files', null=True)),
                ('series_title', models.CharField(blank=True, max_length=500)),
                ('series_number', models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_path', models.CharField(help_text='Full file path', max_length=1000)),
                ('file_path_hash', models.CharField(default='', editable=False, help_text='SHA256 hash for uniqueness', max_length=64, unique=True)),
                ...
                ('first_scanned', models.DateTimeField(auto_now_add=True)),
                ('last_scanned', models.DateTimeField(auto_now=True)),
                ('audiobook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='books.audiobook')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_path', models.CharField(blank=True, help_text='Final file path after renaming operations', max_length=1000)),
                ('last_updated', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path_hash', models.CharField(default='', editable=False, max_length=64)),
            ...
            options={
                ...
                'unique_together': {('path_hash', 'content_type')},
            },
        ),
        migrations.CreateModel(
            name='Comic',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Comic series title', max_length=500)),
                ('title_hash', models.CharField(default='', editable=False, max_length=64)),
                ('publisher', models.CharField(blank=True, max_length=200)),
                ...
                ('status', models.CharField(choices=[('ongoing', 'Ongoing'), ('completed', 'Completed'), ('cancelled', 'Cancelled'), ('unknown', 'Unknown')], default='unknown', max_length=20)),
                ('first_scanned', models.DateTimeField(auto_now_add=True)),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('metadata_extracted', models.BooleanField(default=False)),
                ('cover_path', models.CharField(blank=True, max_length=1000)),
                ('scan_folder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.scanfolder')),
            ],
            options={
                'verbose_name': 'Comic',
        ...
        migrations.AddField(
            ...
            name='scan_folder',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.scanfolder'),
        ),
        migrations.CreateModel(
            name='ScanLog',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_folder_pattern', models.CharField(blank=True, default='${category}/${author.sortname}/${bookseries.title}', help_text='Default folder structure pattern for renaming', max_length=500)),
                ('default_filename_pattern', models.CharField(blank=True, default='${author.sortname} - ${bookseries.title} #${bookseries.number} - ${title}.${ext}', help_text='Default filename pattern for renaming', max_length=500)),
                ('saved_patterns', models.JSONField(blank=True, default=list, help_text='User-saved custom patterns for quick access')),
                ('include_companion_files', models.BooleanField(default=True, help_text='Include companion files (covers, metadata) when renaming by default')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('issue_number', models.CharField(help_text="Issue number (e.g., '1', '1.5', 'Annual 1')", max_length=20)),
                ('file_path', models.CharField(help_text='Full file path', max_length=1000)),
                ('file_path_hash', models.CharField(default='', editable=False, help_text='SHA256 hash for uniqueness', max_length=64, unique=True)),
                ('file_format', models.CharField(max_length=20)),
                ('file_size', models.BigIntegerField(blank=True, null=True)),
                ...
                ('comic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='books.comic')),
            ],
            options={
