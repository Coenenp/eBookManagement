# Generated by Django 5.2.6 on 2026-02-04 11:00
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("Google Books Covers", "Google Books Covers"),
                            ("Manual Entry", "Manual Entry"),
                            ("ISBN Content Scan", "ISBN Content Scan"),
                        ],
                        max_length=50,
                        unique=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.CharField(
                        choices=[("ebooks", "Ebooks"), ("comics", "Comics"), ("audiobooks", "Audiobooks")],
                        default="ebooks",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(choices=[("Pending", "Pending"), ("Running", "Running"), ("Completed", "Completed"), ("Failed", "Failed")], default="Pending", max_length=20),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("completed", "Completed Successfully"), ("failed", "Failed"), ("cancelled", "Cancelled"), ("partial", "Partially Completed")], max_length=20
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(blank=True, default="${author.sortname} - ${bookseries.title} #${bookseries.number} - ${title}.${ext}", max_length=500),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["scan_priority", "needs_external_scan"], name="books_booka_scan_pr_2d36d4_idx"),
                    models.Index(fields=["metadata_completeness"], name="books_booka_metadat_3a90b4_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["-created_at"], name="books_aifee_created_110b85_idx"),
                    models.Index(fields=["needs_retraining"], name="books_aifee_needs_r_d82ae9_idx"),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="external",
                        help_text="Where the cover image comes from",
                        max_length=20,
                    ),
                ),
                ("has_internal_cover", models.BooleanField(default=False, help_text="Whether the file contains an embedded cover")),
                ("cover_internal_path", models.CharField(blank=True, help_text="Path within archive/EPUB for internal covers", max_length=500)),
                ("cover_image_preference", models.CharField(blank=True, help_text="User-selected internal path for preferred cover", max_length=500)),
                ("cover_quality_score", models.IntegerField(blank=True, help_text="Calculated quality score (0-100)", null=True)),
                ("cover_width", models.IntegerField(blank=True, help_text="Cover image width in pixels", null=True)),
                ("cover_height", models.IntegerField(blank=True, help_text="Cover image height in pixels", null=True)),
                ("original_cover_path", models.CharField(blank=True, help_text="Original auto-detected cover path (before manual upload)", max_length=500)),
                ("first_scanned", models.DateTimeField(auto_now_add=True)),
                ("last_scanned", models.DateTimeField(auto_now=True)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["book", "file_format"], name="books_bookf_book_id_a5c416_idx"),
                    models.Index(fields=["book", "chapter_number"], name="books_bookf_book_id_6efea8_idx"),
                    models.Index(fields=["file_path_hash"], name="books_bookf_file_pa_8f8d2a_idx"),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(condition=models.Q(("field_name", ""), _negated=True), name="metadata_field_name_not_empty"),
                    models.CheckConstraint(condition=models.Q(("field_value", ""), _negated=True), name="metadata_field_value_not_empty"),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["book", "is_active", "-confidence"], name="books_booka_book_id_ddc9e6_idx"),
                    models.Index(fields=["author", "is_active"], name="books_booka_author__d6d8e1_idx"),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("success", "Success"), ("rate_limited", "Rate Limited"), ("failed", "Failed"), ("not_attempted", "Not Attempted")],
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["book", "status"], name="books_apiac_book_id_257775_idx"),
                    models.Index(fields=["data_source", "status"], name="books_apiac_data_so_343677_idx"),
                    models.Index(fields=["status", "should_retry"], name="books_apiac_status_9b6629_idx"),
                    models.Index(fields=["next_retry_after"], name="books_apiac_next_re_20f16f_idx"),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("pending", "Pending"), ("completed", "Completed"), ("failed", "Failed"), ("reverted", "Reverted")], default="pending", max_length=20
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["-operation_date"], name="books_fileo_operati_4dfeba_idx"),
                    models.Index(fields=["book", "status"], name="books_fileo_book_id_829e80_idx"),
                    models.Index(fields=["batch_id"], name="books_fileo_batch_i_d75a01_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["is_reviewed"], name="books_final_is_revi_c6814e_idx"),
                    models.Index(fields=["overall_confidence"], name="books_final_overall_902875_idx"),
                    models.Index(fields=["completeness_score"], name="books_final_complet_bcb4ae_idx"),
                    models.Index(fields=["has_cover"], name="books_final_has_cov_2622f4_idx"),
                    models.Index(fields=["has_isbn"], name="books_final_has_isb_0c6b5e_idx"),
                    models.Index(fields=["metadata_complete"], name="books_final_metadat_66235d_idx"),
                ],
                "constraints": [
                    models.CheckConstraint(condition=models.Q(("final_title_confidence__gte", 0), ("final_title_confidence__lte", 1)), name="valid_title_confidence"),
                    models.CheckConstraint(
                        condition=models.Q(("publication_year__isnull", True), models.Q(("publication_year__gte", 1000), ("publication_year__lte", 2100)), _connector="OR"),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["book", "is_active"], name="books_bookg_book_id_99cfd8_idx"),
                    models.Index(fields=["genre", "is_active"], name="books_bookg_genre_i_194f95_idx"),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-confidence"],
                "indexes": [
                    models.Index(fields=["book", "is_active", "-confidence"], name="books_bookp_book_id_c5a2f6_idx"),
                    models.Index(fields=["publisher", "is_active"], name="books_bookp_publish_fefb4a_idx"),
                ],
